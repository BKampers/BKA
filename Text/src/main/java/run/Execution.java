...
public final class Execution {
    ...
    public void run() {
        ...
        execute(engine.getMethods().get(mainOperation));
    ...
    public java.lang.Object execute(Operation operation, ObjectScope parentScope, Map<Parameter, Expression> arguments) {
        ...
        try {
            execute(engine.getMethods().get(operation));
        }
        finally {
    ...
    private static final Predicate<Stereotype> IS_MAIN_STEREOTYPE = stereotype -> "Main".equals(stereotype.getName());
    private static final Predicate<Operation> IS_MAIN_OPERATION = operation -> operation.getStereotypes().stream().anyMatch(IS_MAIN_STEREOTYPE);
